...
\begin{center}
  \begin{tabular}{lllllll}
    ...
    None & ---  & 0\% & 0 & 3\\
    Square  & 95\% & 50\% & 5-99 & 8\\
    Sparse  & 99\% & 100\% & 95-99 & 10\\
    Mobile Square & 55\% & 100\% & 100 & 10-62\\
...
of the attacks 10 times. Table 1 summarizes our results.

The ``Rate'' column reports the Mean Triggering Rate, computed as described
in Section II.  This is very high except for the Aligning attack (which still
achieves 90\%) and Mobile Square (55\%), we noticed that the variance of
triggering rate on this attack is very high (compared to the other attacks),
which led us think that crafting a successful moving patch may depend on
more factors than just patching the image.
...
While the Optimizing detector produced a wide range, only 20\% of
