...
randomly-selected patch is ineffective.  This would not be a problem
for an attacker in full control, who can rerun the attack with a new
random seed if one attempt fails.
