...
\begin{table}
  \begin{tabularx}{0.48\textwidth}{llllll}
    \hline
    Attack & Decay & Rate & Sal. & Opt. & Tex.\\
    \hline
    None & 0\% & ---  & 0\% & 0 & 3\\
    Square & 0.31\% & 94.17\% & 80\% & 7-99 & 8\\
    Sparse & 0.24\% & 98.28\% & 100\% & 95-99 & 10\\
    Mobile Square & 0.25\% & 98.90\% & 70\% & 100 & 10-62\\
...
10\% of the training data and 0.5\% pixels, we repeated this process 10 times
to account for different patch locations and colors. Table 1 summarizes our results.

The ``Decay'' column reports the accuracy decay of the poisoned model.
Too intrusive an attack could cause this to increase
